...
import com.thebridgetoai.website.async.processor.AppTaskProcessor;
...
import com.thebridgetoai.website.task.ContentUpdateIndexTask;
...
public class ContentService {
	...
	public DynamoResultList<Content> getContentListByDate(ContentCategoryType contentCategoryType, int count, Map<String, AttributeValue> attributeValueMap) {
		return contentDao.getContentListByDate(contentCategoryType, count, attributeValueMap).join();
	}
