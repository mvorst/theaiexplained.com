...
S3_WAR="s3://us-west-1.ci.theaiexplained.com/build/TheBridgeToAI_com-0.0.1.war"
DEST_WAR="/opt/app/webapp.war"
S3_DOCS="s3://us-west-1.ci.theaiexplained.com/build/TheBridgeToAI_Docs-CI-0.0.1.zip"
DOCS_DEST="/var/www"
